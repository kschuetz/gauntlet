...
public final class DiscreteDomainTestParameters<A> {
    private final ImmutableVector<A> discreteDomain;
    ...
    public static <A> DiscreteDomainTestParameters<A> discreteDomainTestParameters(ImmutableVector<A> discreteDomain,
