...
import static testsupport.shrink.ShrinkTestCase.clampedShrinkTestCases;
...
class ShrinkNumericsTest extends GauntletApiBase {
    ...
    class Ints {
        ...
        void clamped() {
            ...
            all(clampedShrinkTestCases(generateIntSpan,
                    (min, max) -> generateMostlyInDomain(IntRange.inclusive(min, max)),
                    (min, max) -> shrinkInt(IntRange.inclusive(min, max))))
                    .mustSatisfy(allOf(
