...
final class CompositeArbitraries {
    static <A, B> Arbitrary<Tuple2<A, B>> combine(Arbitrary<A> a,
        ...
        return Arbitrary.arbitrary(parameters -> new CompositeSupply2<>(a.createSupply(parameters),
    ...
    static <A, B, C> Arbitrary<Tuple3<A, B, C>> combine(Arbitrary<A> a,
        ...
        return Arbitrary.arbitrary(parameters -> new CompositeSupply3<>(a.createSupply(parameters),
                        b.createSupply(parameters),
    ...
    static <A, B, C, D> Arbitrary<Tuple4<A, B, C, D>> combine(Arbitrary<A> a,
        ...
        return Arbitrary.arbitrary(parameters -> new CompositeSupply4<>(a.createSupply(parameters),
                        b.createSupply(parameters),
                        c.createSupply(parameters),
    ...
    static <A, B, C, D, E> Arbitrary<Tuple5<A, B, C, D, E>> combine(Arbitrary<A> a,
        ...
        return Arbitrary.arbitrary(parameters -> new CompositeSupply5<>(a.createSupply(parameters),
                        b.createSupply(parameters),
                        c.createSupply(parameters),
                        d.createSupply(parameters),
    ...
    static <A, B, C, D, E, F> Arbitrary<Tuple6<A, B, C, D, E, F>> combine(Arbitrary<A> a,
        ...
        return Arbitrary.arbitrary(parameters -> new CompositeSupply6<>(a.createSupply(parameters),
                        b.createSupply(parameters),
                        c.createSupply(parameters),
                        d.createSupply(parameters),
                        e.createSupply(parameters),
    ...
    static <A, B, C, D, E, F, G> Arbitrary<Tuple7<A, B, C, D, E, F, G>> combine(Arbitrary<A> a,
        ...
        return Arbitrary.arbitrary(parameters -> new CompositeSupply7<>(a.createSupply(parameters),
                        b.createSupply(parameters),
                        c.createSupply(parameters),
                        d.createSupply(parameters),
                        e.createSupply(parameters),
    ...
    static <A, B, C, D, E, F, G, H> Arbitrary<Tuple8<A, B, C, D, E, F, G, H>> combine(Arbitrary<A> a,
        ...
        return Arbitrary.arbitrary(parameters -> new CompositeSupply8<>(a.createSupply(parameters),
                        b.createSupply(parameters),
                        c.createSupply(parameters),
                        d.createSupply(parameters),
                        e.createSupply(parameters),
