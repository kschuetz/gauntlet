...
import static software.kes.gauntlet.GeneratorTestSettings.generatorTestSettings;
import static software.kes.gauntlet.IndexInGroup.indexInGroup;
import static software.kes.gauntlet.IteratorSampleReader.iteratorSampleReader;
import static software.kes.gauntlet.ReportData.reportData;
import static software.kes.gauntlet.TestRunnerSettings.testRunnerSettings;
...
final class Core implements GauntletApi {
    ...
    private <A> UniversalTestResult.Falsified<A> refineResult(GeneratorTestSettings settings,
        ...
        RefinementTest<A> refinementTest = RefinementTest.refinementTest(shrinkStrategy, property, initialResult.getCounterexample().getSample(),
    ...
    private <A> TestResult<A> runDomainTest(DomainTest<A> domainTest) {
        ...
        if (domainTest.getQuantifier() == Quantifier.EXISTENTIAL) {
