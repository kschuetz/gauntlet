...
import static software.kes.gauntlet.TestRunnerUtils.getBlockTimeout;
import static software.kes.gauntlet.TestRunnerUtils.getDeadline;
...
final class ExistentialTestRunner {
    ...
    private <Sample, A> Either<Abnormal<Sample>, ExistentialTestResult<Sample>> runBlock(Executor executor,
                                                                                         ...
                                                                                         Prop<A> property) {
        ResultCollector.ExistentialResultCollector<Sample> collector = ResultCollector.existentialResultCollector(elements);
