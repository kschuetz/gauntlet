...
import static software.kes.gauntlet.prop.Facade.biconditional;
import static software.kes.gauntlet.prop.Facade.conjunction;
import static software.kes.gauntlet.prop.Facade.disjunction;
import static software.kes.gauntlet.prop.Facade.exclusiveDisjunction;
import static software.kes.gauntlet.prop.Facade.implication;
import static software.kes.gauntlet.prop.Facade.negation;
import static software.kes.gauntlet.prop.Facade.whenExecuting;
...
final class PropsTest {
    ...
    class AlwaysPass {
        @Test
        void passes() {
            assertThat(Prop.alwaysPass().evaluate(0), isEvalSuccess());
        }
    }
    ...
    class AlwaysFail {
        @Test
        void fails() {
            assertThat(Prop.alwaysFail().evaluate(0), isEvalFailure());
        }

        @Test
        void failsWithReasonGiven() {
            assertThat(Prop.alwaysFail("because").evaluate(0),
